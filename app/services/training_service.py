...
GSA_18DS và GSA_14DS, 4. Các chương trình đào tạo chất lượng cao ở Tuyển sinh" vào câu truy vấn viết lại và không viết gì thêm sau đó.
    ...
    async def llm_document_recommendation_check(
        ...
        - Trả về "nope" CHỈ KHI Context rơi vào các trường hợp sau:
            ...
            3. SAI HỆ ĐÀO TẠO (QUAN TRỌNG): Hãy chú ý đến thẻ [Nguồn: ...] và nội dung theo sau. Nếu tài liệu (hoặc tên nguồn) ghi rõ là dành cho các hệ khác (như Vừa làm vừa học, Từ xa, Thạc sĩ, Sau đại học...) mà KHÔNG có thông tin cho hệ người dùng yêu cầu (hoặc hệ Chính quy mặc định), BẮT BUỘC trả về "nope". (Ví dụ: Người dùng hỏi chung chung -> ngầm hiểu là Chính quy, nhưng context có [Nguồn: HD597-HuongDanChuyenHe sang vualamvuahoc] thì phải trả về "nope").
        === DỮ LIỆU ĐẦU VÀO ===
